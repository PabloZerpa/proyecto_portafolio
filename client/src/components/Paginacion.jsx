...
function Paginacion({primero=1,ultimo=10,total=100}) {

    return(
        <div class="flex flex-col items-center my-4">
            <span class="text-xs text-gray-800">
                Mostrando del
            <span class="font-semibold text-gray-900"> {primero}</span> al <span class="font-semibold text-gray-900">{ultimo}</span> de <span class="font-semibold text-gray-900">{total}</span> Resultados</span>
