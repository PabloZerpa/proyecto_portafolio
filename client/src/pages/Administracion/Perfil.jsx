...
function Perfil({tipo='admin'}) {
    ...
    return(
        <Container>
            ...
            <div className="flex flex-col w-3/4 justify-start gap-8 border-2 border-dashed border-blue-500">
            ...
            <div className="flex w-3/4 justify-start gap-8 border-2 border-dashed border-blue-500">
                <div className="w-3/4">
